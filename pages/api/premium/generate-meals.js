...
// كل نوع فيه > 10 أصناف + أضفنا مصادر كثيرة زي ما طلبت
...
const MEAL_SOURCE_CONFIG = {
  ...
  // بناء حصة طعام واحدة بكميّة محسوبة
  ...
  function buildMealForType(type, base, dist) {
    ...
    for (let i = 0; i < 25; i++) {
      ...
      if (score < bestScore) {
        ...
        if (bestScore < 0.20) break; // قريب جداً
      }
    }
